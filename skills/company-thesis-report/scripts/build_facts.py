...
def empty_pack(name: str) -> dict:
    defaults = {
        ...
        "milestones": {"items": []},
        "financials": {"rows": [], "cagr": {}, "balance_sheet_anomaly": {"found": False, "notes": []}, "lens_metric_cards": []},
        "segments": {"tables": [], "gap": ""},
        "demand": {"material": False, "rows": [], "gap": ""},
        "operations": {"footprint": [], "raw_materials": {}, "capacity": {}, "tam": {}},
        "valuation": {"method": "", "inputs": {}, "notes": [], "sources": []},
        "peers": {"columns": [], "rows": []},
        "moats": {"items": []},
        "risks": {"items": []},
        "thesis": {"items": []},
        "governance": {"shareholding": [], "ratings": [], "litigation": [], "fund_raises": []},
        "technicals": {"items": [], "gap": ""},
        "quotes": {"items": []},
        "sector_overlay": {"lens_id": "", "deep_dive_blocks": [], "metric_cards": [], "query_hits": {}},
    }
